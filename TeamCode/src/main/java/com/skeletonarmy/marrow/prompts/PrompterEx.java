...
//
//    public PrompterEx(OpMode opMode) {
//        this.opmode = opMode;
//    }
//
//    /**
...
//     */
//    public <T> PrompterEx prompt(String key, Prompt<T> prompt) {
...
//     * Add a prompt to the queue.
//     */
//    public <T> PrompterEx prompt(String key, Supplier<Prompt<T>> promptSupplier) {
...
//     */
//    public PrompterEx onComplete(Runnable func) {
//        completeFunc = func;
//        return this; // For method chaining
//    }
//
