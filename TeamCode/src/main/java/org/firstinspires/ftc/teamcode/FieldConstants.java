...
public class FieldConstants {
    ...
    public static Pose BLUE_START_POS_TELEOP = new Pose(20, 123, Math.toRadians(52.3-180));
    public static Pose RED_START_POS_TELEOP = new Pose(124, 123,  Math.toRadians(-225+90));
