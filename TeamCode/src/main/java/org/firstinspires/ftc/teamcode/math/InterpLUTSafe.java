...
public class InterpLUTSafe {
    ...
    private InterpLUTSafe(List<Double> x, List<Double> y, List<Double> m) {
        this(x, y, m, false);
    }

    private InterpLUTSafe(List<Double> x, List<Double> y, List<Double> m, boolean safeMode) {
        mX = x;
        mY = y;
        mM = m;
    ...
    public InterpLUTSafe(List<Double> input, List<Double> output) {
        this(input, output, false);
    }

    public InterpLUTSafe(List<Double> input, List<Double> output, boolean safeMode) {
     ...
     */
    public InterpLUTSafe add(double input, double output) {
        mX.add(input);
        mY.add(output);
     ...
     * @return this class (for chaining calls)
     */
    public InterpLUTSafe createLUT() {
    ...
    public InterpLUTSafe setSafeMode(boolean safeMode) {
        this.safeMode = safeMode;
        return this;
    }
