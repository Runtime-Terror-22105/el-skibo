...
//    }
    ...
    public static Pose2d PUSH_GATE_POSE = new Pose2d(20, 70, Math.toRadians(180));
    ...
    public static Pose2d AFTER_GATE = new Pose2d(10, 62.2, Math.toRadians(162));
    ...
    private PathChain beforePushGate2Path, pushGateIntake2Path;
