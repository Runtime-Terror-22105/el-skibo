...
public abstract class AutoSpamNoPushGate2 extends OneAutoToRuleThemAll {
    ...
    protected Command createAutoCommand(AutoBuilder builder) {
        return new SequentialCommandGroup(
                ...
                builder.cycleGate(ShootPathFlag.EARLY_SHOOT, ShootPathFlag.EARLY_LEAVE),
                builder.cycleGate(ShootPathFlag.EARLY_SHOOT, ShootPathFlag.EARLY_LEAVE),
                builder.cycleGate(ShootPathFlag.LAST, ShootPathFlag.EARLY_SHOOT, ShootPathFlag.EARLY_LEAVE)
        );
    }
}