...
public class DrivetrainWheelPidTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            HangSubsystem.HangMotorPositionPair powers = robot.hang.calculateHangMotorPowers(true);
            ...
            robot.telemetry.addData("Current Position Right (deg)", Math.toDegrees(currentPositions.getRight()));
            robot.telemetry.addData("Target Positions Left (deg)", MOTOR_POSITIONS_DEGREES.getLeft());
            robot.telemetry.addData("Target Positions Right (deg)", MOTOR_POSITIONS_DEGREES.getRight());
