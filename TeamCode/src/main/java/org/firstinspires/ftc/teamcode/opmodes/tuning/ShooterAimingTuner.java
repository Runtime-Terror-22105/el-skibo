...
public class ShooterAimingTuner extends LinearOpMode {
    ...
    public static double DIST_TO_GOAL_X = -1; // in mm
    public static double DIST_TO_GOAL_Y = -1; // in mm
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            robot.shooter.doAutoShoot(robotPose);
            ...
            robot.telemetry.addData("Goal Velocity", GOAL_RPM);
