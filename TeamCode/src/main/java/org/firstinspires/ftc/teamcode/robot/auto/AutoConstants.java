...
public class AutoConstants {
    ...
    public static Pose2d SHOOT_FAR_POSE = new Pose2d(48-3.315, 10, Math.toRadians(180));
...
//    public static Pose2d SHOOT_FAR_POSE_FORWARD_FACING = SHOOT_FAR_POSE;
    ...
    public static Pose2d PREPARE_INTAKE_3_CONTROL_FAR = new Pose2d(49-3.315, 31);
    public static Pose2d PREPARE_INTAKE_3_POSE_FAR = new Pose2d(36.42918454935622-3.315, 30, Math.toRadians(180));
    ...
    public static Pose2d INTAKE_WALL_POSE = new Pose2d(12, 8.2, Math.toRadians(180));
    public static Pose2d INTAKE_WALL_POSE_2 = new Pose2d(17, 8, Math.toRadians(195)); // rotate into the balls a bit to avoid jams
    public static Pose2d INTAKE_WALL_VISION_POSE = new Pose2d(13-3.315, 6, Math.toRadians(180));
