...
public class AutoConstants {
    ...
    public static Pose2d SHOOT_PRELOAD_POSE = new Pose2d(103, 60, Math.toRadians(-124.7));
    public static Pose2d SHOOT_PRELOAD_HORIZ_POSE = new Pose2d(24, 115, Math.toRadians(225));
    public static Pose2d SHOOT_EDGE_POSE = new Pose2d(103, 60, Math.toRadians(-124.7));
