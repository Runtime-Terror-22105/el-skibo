...
// NOTE: Copied from https://github.com/jdhs-ftc/road-runner-ftc-otos/blob/master/RoadRunner/src/main/java/com/acmerobotics/roadrunner/ftc/SparkFunOTOSCorrected.kt
...
class TerrorSparkFunOTOS(deviceClient: I2cDeviceSynch) : SparkFunOTOS(deviceClient) {
    /**
