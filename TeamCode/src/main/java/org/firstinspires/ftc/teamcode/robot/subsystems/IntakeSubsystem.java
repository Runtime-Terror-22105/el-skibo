...
public class IntakeSubsystem extends SubsystemBase {
    ...
    public static double REVERSE_SPEED = -1;

    public static boolean debug = false;

    public static double INTAKE_LEFT_DOWN = 0.53;
    public static double INTAKE_LEFT_UP = 0.7;

    public static double INTAKE_RIGHT_DOWN = 0.43;
    public static double INTAKE_RIGHT_UP = 0.29;
