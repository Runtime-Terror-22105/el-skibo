...
public class ShooterSubsystem extends SubsystemBase {
    ...
    // hood limits
    public static double hoodPosMax = 1; //maximum position the servo can go to
...
//        boolean useSmallPID = shooterPID.atTargetPositionWithTolerance(currentRpm, SHOOTER_PID_SWITCH);
       ...
       // double shooterPower = 0.0;
        ...
        if ((getGoalVelocity() - currentRpm < SHOOTER_VEL_MAXPOWER_TOLERANCE) && (getGoalVelocity() - currentRpm > 0) && robot.getState().equals(RobotState.SHOOTING)) {
